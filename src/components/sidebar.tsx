    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.2, delay: isCollapsed ? 0 : 0.5 }}
          className="p-4 mt-auto border-t border-navy-light"
        >
          <button
            onClick={() => setShowConfigModal(true)}
            className={cn(
              "w-full p-3 rounded-lg",
              "bg-navy-light/50 border border-navy-lighter",
              "text-navy-lightest hover:bg-navy-light/70 transition-colors",
